#ترجمه فريق مصطفى على التيلكرام
import json

import requests
#ترجمه فريق مصطفى على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import Adyan, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    Adyanresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, Adyanresult, "html")
