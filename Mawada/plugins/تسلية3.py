...
from . import Adyan, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m Mawada`",
        "**State changed from starting to up**",
        "__INFO:Mawada:Logged in as 557667062__",
        "__INFO:Mawada:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
