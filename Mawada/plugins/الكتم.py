...
@Adyan.ar_cmd(pattern=f"كتم(?:\s|$)([\s\S]*)")
...
@Adyan.ar_cmd(pattern=f"(الغاء الكتم|الغاء كتم)(?:\s|$)([\s\S]*)")
...
@Adyan.ar_cmd(pattern=r"قائمة المكتومين")
