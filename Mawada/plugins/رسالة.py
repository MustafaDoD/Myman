...
@Adyan.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}رسالة @rre3l حي الله  ان",
    },
)
...
@Adyan.ar_cmd(pattern="ازالة التوجيه")
async def Reda (event):
    if event.message.reply_to_msg_id:
        ...
        if replied_msg.media:
            ...
            await Adyan.send_message(event.chat_id, "", file=replied_msg.media)
        else:
            
            await Adyan.send_message(chat_id=event.chat_id, message=replied_msg.message)
    else:
