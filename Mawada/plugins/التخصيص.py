...
@Adyan.ar_cmd(pattern="اضف صورة (الفحص|فحص) ?(.*)")
async def alive_Mustafa(event):
    reply = await event.get_reply_message()
...
@Adyan.ar_cmd(pattern="اضف صورة (البنك|بنك) ?(.*)")
async def add_ping_Mustafa(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        media = await reply.download_media()
        ...
        await event.edit("**᯽︙ يرجى الرد على الصورة لتحديث الفار**")
@Adyan.ar_cmd(pattern="اضف صورة (الحماية|الحمايه|حماية|حمايه) ?(.*)")
async def security_Mustafa(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        media = await reply.download_media()
...
@Adyan.ar_cmd(pattern="اضف صورة (الخاص|خاص) ?(.*)")
async def al5a9_Mustafa(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        media = await reply.download_media()
