...
from . import Adyan, edit_or_reply, logging, reply_id
...
Mawada = "36980ed85a0d7008872784656e7ff2c8"
@Adyan.ar_cmd(
    pattern="الطقس(?:\s|$)([\s\S]*)",
...
async def get_weather(event):  # sourcery no-metrics
    ...
    url = f"https://api.openweathermap.org/data/2.5/weather?q={CITY}&appid={Mawada}"
