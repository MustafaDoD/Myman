...
@Adyan.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular Mawada",
    },
)
...
@Adyan.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular Mawada",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@Adyan.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna Mawada is One of the Popular Mawada",
    },
)
async def nekobot(cat):
...
@Adyan.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; Mawada is One of the Popular Mawada",
    },
)
async def nekobot(cat):
