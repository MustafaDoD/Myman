...
import json
import os
from Mawada.helpers.functions.functions import translate
...
@Adyan.ar_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
async def reda(event):
...
@Adyan.ar_cmd(pattern="لغة الترجمة")
