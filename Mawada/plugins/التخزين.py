...
@Adyan.ar_cmd(incoming=True, func=lambda e: e.is_private, edited=True, forword=None)
...
@Adyan.ar_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
