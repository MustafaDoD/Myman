...
PATH = "./Mawada/cache/ytsearch.json"
...
async def yt_search(Mawada):
    try:
        Mawada = urllib.parse.quote(Mawada)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={Mawada}"
        )
...
"""
async def yt_data(Mawada):
    params = {"format": "json", "url": Mawada}
